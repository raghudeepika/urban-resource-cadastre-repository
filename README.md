...
|--------------|---------------------|--------------------|-------------------|-------------------|-------------------|-------------------|
| TKY          | Vision Transformer  | **0.86** (±0.07)   | 0.03 (±0.02)      | 0.94 (±0.05)      | 0.89 (±0.06)      | **0.91** (±0.06)  |
|              | Swin Transformer V2 | 0.83 (±0.03)      | **0.03** (±0.01) | 0.93 (±0.03)      | **0.90** (±0.05) | 0.90 (±0.03)      |
|              | ConvNeXt            | 0.82 (±0.03)      | 0.04 (±0.00)      | **0.97** (±0.03)  | 0.84 (±0.04)      | 0.89 (±0.01)      |
|              |                     |                   |                   |                   |                   |                   |
| NYC          | Vision Transformer  | 0.79 (±0.08)      | 0.04 (±0.02)      | 0.94 (±0.03)      | 0.85 (±0.05)      | 0.89 (±0.05)      |
|              | Swin Transformer V2 | **0.82** (±0.07)   | 0.04 (±0.01)      | 0.94 (±0.02)      | **0.90** (±0.05) | 0.91 (±0.04)      |
|              | ConvNext            | 0.81 (±0.05)      | **0.03** (±0.01) | **0.95** (±0.01)  | 0.89 (±0.05)      | **0.91** (±0.03)  |
|              |                     |                   |                   |                   |                   |                   |
| ZRH          | Vision Transformer  | 0.83 (±0.05)      | 0.04 (±0.01)      | 0.96 (±0.02)      | 0.91 (±0.05)      | 0.93 (±0.02)      |
|              | Swin Transformer V2 | **0.87** (±0.04)   | 0.03 (±0.01)      | 0.95 (±0.02)      | **0.95** (±0.02) | **0.95** (±0.01)  |
|              | ConvNext            | **0.91** (±0.02)   | **0.02** (±0.00) | **0.99** (±0.01)  | 0.94 (±0.04)      | **0.96** (±0.02)  |
|              |                     |                   |                   |                   |                   |                   |
| All          | Vision Transformer  | 0.82 (±0.07)      | 0.03 (±0.01)      | 0.89 (±0.03)      | 0.82 (±0.03)      | 0.85 (±0.02)      |
|              | Swin Transformer V2 | **0.87** (±0.04)   | 0.02 (±0.01)      | **0.96** (±0.02)  | **0.91** (±0.03) | **0.93** (±0.03)  |
|              | ConvNext            | 0.86 (±0.01)      | 0.02 (±0.00)      | 0.94 (±0.01)      | 0.89 (±0.02)      | 0.91 (±0.01)      |
...
|       | Model               | LR      | GAS | WD   | RA  |
|-------|---------------------|---------|-----|------|-----|
| TKY   | Vision Transformer | 1e-4    | 8   | 0.01 | 16  |
|       | Swin Transformer V2 | 5e-5    | 8   | 0.01 | 16  |
|       | ConvNeXt | 1-4     | 4   | 0.01 | 8   |
|       |                     |         |     |      |     |
| NYC   | Vision Transformer| 2e-5    | 4   | 0.05 | 16  |
|       | Swin Transformer V2 | 1e-4    | 8   | 0.1  | 16  |
|       | ConvNeXt | 1e-4    | 4   | 0.01 | 8   |
|       |                     |         |     |      |     |
| ZRH   | Vision Transformer| 2e-5    | 4   | 0.05 | 16  |
|       | Swin Transformer V2 | 1e-4    | 16  | 0.05 | 16  |
|       | ConvNeXt | 1e-4    | 4   | 0.05 | 8   |
|       |                     |         |     |      |     |
| All   | Vision Transformer | 1e-4    | 8   | 0.1  | 8   |
|       | Swin Transformer V2 | 1e-4    | 4   | 0.1  | 8   |
|       | ConvNeXt | 1e-4    | 4   | 0.05 | 16  |
